...
This fork is my daily driver but it is bound to have bugs, so the usual apply; use at your own peril etc. For more info, go read the original README contents from electh/ReactFlux:main.
